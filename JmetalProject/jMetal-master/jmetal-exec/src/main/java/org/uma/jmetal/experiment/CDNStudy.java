...
//import org.uma.jmetal.problem.multiobjective.MultiobjCDN;
...
// */
//public class CDNStudy {
//  private static final int INDEPENDENT_RUNS = 12 ;
//
//  public static void main(String[] args) throws IOException {
////    if (args.length != 2) {
////      throw new JMetalException("Needed arguments: experimentBaseDirectory referenceFrontDirectory") ;
////    }
//    String experimentBaseDirectory = "/home/ggoni/Documentos/proye/proycodigo/salida/referenceFrontDirectory" ;
//    String referenceFrontDirectory = "/home/ggoni/Documentos/proye/proycodigo/salida/experimentBaseDirectory" ;
//
//    String nombreArchivoPropertiesInstancia="300Vid_300Mins_6Prove_1XreG_1XreQ";
//
//
//
//    List<Problem<CDNSolution>> problemList = Arrays.<Problem<CDNSolution>>asList(new MultiobjCDN(nombreArchivoPropertiesInstancia)) ;
//
...
//        new ExperimentBuilder<CDNSolution, List<CDNSolution>>("CDNStudy")
...
////        Algorithm<List<CDNSolution>> algorithm = new NSGAIIBuilder<>(problemList.get(i), new SBXCrossover(1.0, 20.0),
...
//        int formaDeInit=1;
//        MultiobjCDN problem = (MultiobjCDN)problemList.get(i);
...
//                .build() ;
//
//        algorithms.add(new TaggedAlgorithm<List<CDNSolution>>(algorithm, "NSGAII_CDNStudy", problemList.get(i), run));
//      }
//
//
//    }
